...
<body>
    ...
    <div class="container1" >
        ...
        <div class= "<?php if ( $time_slot_1 == "1" ) { echo "invalid"; } else if($time_slot_1 == "1.") { echo "warn";} else { echo "container";} ?>" name = "time_slot_1">
            Time Slot 1 <br> 09:00 AM - 11:00 AM
            
        </div>
        </a>
        
        <div class= "<?php if ( $time_slot_2 == "1" ) { echo "invalid"; } else if($time_slot_2 == "2") { echo "warn";} else { echo "container";}?>" name = "time_slot_2">
            Time Slot 2 <br> 01:00 PM - 03:00 PM 
        </div>
        <div class= "<?php if ( $time_slot_3 == "1" ) { echo "invalid"; } else if($time_slot_3 == "1.") { echo "warn";} else { echo "container";}?>" name = "time_slot_3">
            Time Slot 3 <br> 03:30 PM - 05:30 PM 
        </div>
    </div>

    <div class="container2">
        <div class= "<?php if ( $time_slot_4 == "1" ) { echo "invalid"; } else if($time_slot_4 == "1.") { echo "warn";} else { echo "container";}?>" name = "time_slot_4">
            Time Slot 4 <br> 06:00 PM - 08:00 PM 
        </div>
        <div class= "<?php if ( $time_slot_5 == "1" ) { echo "invalid"; } else if($time_slot_5 == "1.") { echo "warn";} else { echo "container";}?>" name = "time_slot_5">
